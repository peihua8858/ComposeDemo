...
public class PullRefreshLayout extends ViewGroup
  ...
  private boolean onHeaderPullFinish(@RefreshFlag int flag) {
    if (headerView instanceof OnPullListener) {
  ...
  private boolean onFooterPullFinish(@RefreshFlag int flag) {
    if (footerView instanceof OnPullListener) {
  ...
  public interface OnPullListener {
    ...
    void onPullFinish(@RefreshFlag int flag);
  ...
  private class PullAnimatorListenerAdapter extends AnimatorListenerAdapter {
    private @RefreshFlag  int flag = 1;
    ...
    public void setFlag(@RefreshFlag int flag) {
      this.flag = flag;
    }
  ...
  public void refreshComplete() {
    refreshComplete(RefreshFlag.NONE);
  }

  public void refreshComplete(@RefreshFlag int flag) {
  ...
  public void loadMoreComplete() {
    loadMoreComplete(RefreshFlag.NONE);
  }

  public void loadMoreComplete(@RefreshFlag int flag) {
